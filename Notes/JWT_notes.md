...
Hashing is a **one-way cryptographic process** that converts data (like a password) into a well cal **fixed-length string**.
...
- `"md5"` is the hashing algorithm (Message Digest 5) **MD5 is NOT secure for real apps**
- **VERY FAST** -> brute force easy
